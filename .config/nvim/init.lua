...
-- ADD THESE LINES FOR 2-SPACE TABS:
vim.opt.tabstop = 2
...
-- Note: <leader>q is already used for diagnostics in kickstart, so we'll use different keys
vim.keymap.set("n", "<leader>qq", "<cmd>q<CR>", { desc = "Quit" })
vim.keymap.set("n", "<leader>Q", "<cmd>q!<CR>", { desc = "Force quit without saving" })

-- Copying Operations
vim.keymap.set("n", "<leader>ya", "ggVGy", { desc = "Copy entire file" })
...
vim.keymap.set("n", "<leader>x", function()
	...
	print("Made file executable: " .. vim.fn.expand("%"))
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		opts = {
			...
			spec = {
				...
				{ "<leader>t", group = "Tab/Toggle", mode = { "n", "v" } },
				{ "<leader>y", group = "Yank/Copy", mode = { "n", "v" } },
			},
		},
	},
		...
		config = function()
			...
			require("telescope").setup({
				...
				defaults = {
					...
					layout_config = {
						-- horizontal = {
						-- 	preview_width = 0.66, -- Make preview window take 2/3 of total width
						-- 	results_width = 0.33, -- (optional) Just for clarity, though it's calculated
						-- },
						width = 0.95, -- Total popup width (95% of the editor)
